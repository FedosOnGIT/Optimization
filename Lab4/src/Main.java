...
import methods.quasi_methods.PowellMethod;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        QuasiMethod powell = new PowellMethod(new BrentMethod());
        Vector answer = powell.min(Main::function, hessian, gradient, new Vector(4.0, 1.0), 0.0001);
