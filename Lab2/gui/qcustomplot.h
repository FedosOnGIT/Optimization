...
/*!
  Defines what objects of a widgetPlot can be forcibly drawn antialiased/not antialiased. If an object is
...
enum PlottingHint { phNone              = 0x000 ///< <tt>0x000</tt> No hints are set
                    ...
                    ,phImmediateRefresh = 0x002 ///< <tt>0x002</tt> causes an immediate repaint() instead of a soft update() when QCustomPlot::replot() is called with parameter \ref QCustomPlot::rpRefreshHint.
                                                ///<                This is set by default to prevent the widgetPlot from freezing on fast consecutive replots (e.g. user drags ranges with mouse).
...
class QCP_LIB_DECL QCPLayerable : public QObject
{
  ...
  /// \endcond
public:
  QCPLayerable(QCustomPlot *widgetPlot, QString targetLayer=QString(), QCPLayerable *parentLayerable=nullptr);
...
protected:
  ...
  struct LabelData
  {
    ...
    QTransform transform; // the transform about the label anchor which is at (0, 0). Does not contain final absolute x/y positioning on the widgetPlot/axis
...
public:
  ...
  */
  enum PositionType { ptAbsolute        ///< Static positioning in pixels, starting from the top left corner of the viewport/widget.
                      ...
                      ,ptPlotCoords     ///< Dynamic positioning at a widgetPlot coordinate defined by two axes (see \ref setAxes).
                    };
...
QCPDataSelection QCPAbstractPlottable1D<DataType>::selectTestRect(const QRectF &rect, bool onlySelectable) const
{
  ...
  // convert rect given in pixels to ranges given in widgetPlot coordinates:
...
{
  // if drawing lines in widgetPlot (instead of PDF), reduce 1px lines to cosmetic, because at least in
...
public:
  ...
  */
  ...
  /*!
    Defines how NaN data points shall appear in the widgetPlot.
...
public:
  /*!
    Defines how the graph's line is represented visually in the widgetPlot. The line is drawn with the
...
public:
  /*!
    Defines how the curve's line is represented visually in the widgetPlot. The line is drawn with the
...
public:
  ...
  */
  ...
  /*!
    Defines the possible representations of OHLC data in the widgetPlot.
