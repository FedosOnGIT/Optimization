...
public:
    ...
    QRadioButton *f1RadioButton;
    QSpacerItem *horizontalSpacer;
    QHBoxLayout *horizontalLayout_2;
    QRadioButton *f2RadioButton;
    QSpacerItem *horizontalSpacer_2;
    QHBoxLayout *horizontalLayout_3;
    QRadioButton *f3RadioButton;
...
"color: rgb(0, 0, 0);"));
        ...
        chooseFuncWidget->setMinimumSize(QSize(531, 151));
        verticalLayout_4 = new QVBoxLayout(chooseFuncWidget);
        verticalLayout_4->setObjectName(QString::fromUtf8("verticalLayout_4"));
        label_2 = new QLabel(chooseFuncWidget);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setMinimumSize(QSize(181, 16));
        ...
        f1RadioButton = new QRadioButton(chooseFuncWidget);
        f1RadioButton->setObjectName(QString::fromUtf8("f1RadioButton"));
        f1RadioButton->setMinimumSize(QSize(531, 31));
        f1RadioButton->setMaximumSize(QSize(531, 16777215));
        f1RadioButton->setStyleSheet(QString::fromUtf8("image: url(:/images/f1.png);\n"
""));

        horizontalLayout_1->addWidget(f1RadioButton);
        ...
        f2RadioButton = new QRadioButton(chooseFuncWidget);
        f2RadioButton->setObjectName(QString::fromUtf8("f2RadioButton"));
        f2RadioButton->setMinimumSize(QSize(421, 31));
        f2RadioButton->setMaximumSize(QSize(421, 16777215));
        f2RadioButton->setStyleSheet(QString::fromUtf8("image: url(:/images/f2.png);\n"
""));

        horizontalLayout_2->addWidget(f2RadioButton);
        ...
        f3RadioButton = new QRadioButton(chooseFuncWidget);
        f3RadioButton->setObjectName(QString::fromUtf8("f3RadioButton"));
        f3RadioButton->setMinimumSize(QSize(351, 31));
        f3RadioButton->setMaximumSize(QSize(351, 16777215));
        f3RadioButton->setStyleSheet(QString::fromUtf8("image: url(:/images/f3.png);\n"
""));

        horizontalLayout_3->addWidget(f3RadioButton);
        ...
        gridLayout_12->addWidget(chooseFuncWidget, 0, 0, 1, 1);
        ...
        gridLayout_12->addWidget(chooseMethodWidget, 1, 0, 1, 1);
        ...
        errorMethodInfo->setMinimumSize(QSize(0, 0));
        ...
        gridLayout_12->addWidget(errorStackedWidget, 3, 0, 1, 1);
        ...
        findMinPushButton->setStyleSheet(QString::fromUtf8("font: 75 italic 16pt \"CMU Serif\";\n"
"color: rgb(35, 35, 255);\n"
...
"padding: 6px;"));
        ...
        backPushButton->setStyleSheet(QString::fromUtf8("font: 75 italic 16pt \"CMU Serif\";\n"
"color: rgb(0, 0, 0);\n"
"border-color: rgb(0, 0, 0);\n"
"border-style: outset;\n"
"border-width: 2px;\n"
...
"padding: 6px;"));
        ...
        restartPushButton->setStyleSheet(QString::fromUtf8("font: 75 italic 16pt \"CMU Serif\";\n"
"color: rgb(0, 0, 0);\n"
"border-color: rgb(0, 0, 0);\n"
"border-style: outset;\n"
"border-width: 2px;\n"
...
"padding: 6px;"));
        ...
        errorStackedWidget->setCurrentIndex(1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_2->setText(QCoreApplication::translate("MainWindow", "1.  \320\222\321\213\320\261\320\265\321\200\320\270\321\202\320\265 \321\204\321\203\320\275\320\272\321\206\320\270\321\216:", nullptr));
        f1RadioButton->setText(QString());
        f2RadioButton->setText(QString());
        f3RadioButton->setText(QString());
        enterInputDataLabel->setText(QCoreApplication::translate("MainWindow", "3.  \320\222\320\262\320\265\320\264\320\270\321\202\320\265 \320\262\321\205\320\276\320\264\320\275\321\213\320\265 \320\264\320\260\320\275\320\275\321\213\320\265:", nullptr));
        chooseMethodLabel->setText(QCoreApplication::translate("MainWindow", "2.  \320\222\321\213\320\261\320\265\321\200\320\270\321\202\320\265 \320\274\320\265\321\202\320\276\320\264:", nullptr));
        comboBox->setItemText(0, QCoreApplication::translate("MainWindow", "-", nullptr));
        comboBox->setItemText(1, QCoreApplication::translate("MainWindow", "\320\234\320\265\321\202\320\276\320\264 \320\264\320\270\321\205\320\276\321\202\320\276\320\274\320\270\320\270", nullptr));
        comboBox->setItemText(2, QCoreApplication::translate("MainWindow", "\320\234\320\265\321\202\320\276\320\264 \320\267\320\276\320\273\320\276\321\202\320\276\320\263\320\276 \321\201\320\265\321\207\320\265\320\275\320\270\321\217", nullptr));
        comboBox->setItemText(3, QCoreApplication::translate("MainWindow", "\320\234\320\265\321\202\320\276\320\264 \320\244\320\270\320\261\320\276\320\275\320\260\321\207\321\207\320\270", nullptr));
        comboBox->setItemText(4, QCoreApplication::translate("MainWindow", "\320\234\320\265\321\202\320\276\320\264 \320\277\320\260\321\200\320\260\320\261\320\276\320\273", nullptr));
        comboBox->setItemText(5, QCoreApplication::translate("MainWindow", "\320\232\320\276\320\274\320\261\320\270\320\275\320\270\321\200\320\276\320\262\320\260\320\275\320\275\321\213\320\271 \320\274\320\265\321\202\320\276\320\264 \320\221\321\200\320\265\320\275\321\202\320\260", nullptr));

        epsLabel->setText(QString());
        deltaLabel->setText(QString());
        errorFuncInfo->setText(QString());
        errorMethodInfo->setText(QString());
        errorEpsInfo->setText(QString());
        errorDeltaInfo->setText(QString());
        findMinPushButton->setText(QCoreApplication::translate("MainWindow", "\320\235\320\260\320\271\321\202\320\270 \320\274\320\270\320\275\320\270\320\274\321\203\320\274", nullptr));
        backPushButton->setText(QCoreApplication::translate("MainWindow", "\320\235\320\260\320\267\320\260\320\264", nullptr));
        restartPushButton->setText(QCoreApplication::translate("MainWindow", "\320\237\320\265\321\200\320\265\320\267\320\260\320\277\321\203\321\201\320\272", nullptr));
    } // retranslateUi
